...
const BottomTab=({ setIsLoggedIn })=>{
    ...
    return (
        ...
        <Tab.Screen name="Category" component={Category} options={{ headerStyle:{backgroundColor: '#1A3A5C'}, headerTintColor: '#FFF', headerTitleStyle:{fontSize: 18, fontWeight: '600', color: '#FFFFFF'}}}/>
